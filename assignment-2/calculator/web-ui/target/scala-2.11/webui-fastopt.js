...
$c_Lcalculator_Calculator$.prototype.$$undeval__p1__Lcalculator_Expr__sci_List__sci_Map__D = (function(expr, dep, references) {
  __eval: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Ref(x1)) {
      ...
      var name = x2.name$2;
      var this$1 = dep;
      if ($s_sc_LinearSeqOptimized$class__contains__sc_LinearSeqOptimized__O__Z(this$1, name)) {
        var _2 = dep;
        var this$3 = $m_s_Console$();
        var this$4 = this$3.outVar$2;
        var this$5 = $as_Ljava_io_PrintStream(this$4.tl$1.get__O());
        this$5.printString__p4__T__V((((("(" + name) + ",") + _2) + ")"));
        this$5.printString__p4__T__V("\n");
        return (NaN)
      } else {
        ...
        var temp$dep = $as_sci_List($s_sc_SeqLike$class__$$colon$plus__sc_SeqLike__O__scg_CanBuildFrom__O(this$8, name, bf));
        expr = temp$expr;
        dep = temp$dep;
        continue __eval
      }
      ...
      var a = x3.a$2;
      var b = x3.b$2;
      return (this.$$undeval__p1__Lcalculator_Expr__sci_List__sci_Map__D(a, dep, references) + this.$$undeval__p1__Lcalculator_Expr__sci_List__sci_Map__D(b, dep, references))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x4 = $as_Lcalculator_Minus(x1);
      var a$2 = x4.a$2;
      var b$2 = x4.b$2;
      return (this.$$undeval__p1__Lcalculator_Expr__sci_List__sci_Map__D(a$2, dep, references) - this.$$undeval__p1__Lcalculator_Expr__sci_List__sci_Map__D(b$2, dep, references))
    } else if ($is_Lcalculator_Times(x1)) {
      var x5 = $as_Lcalculator_Times(x1);
      var a$3 = x5.a$2;
      var b$3 = x5.b$2;
      return (this.$$undeval__p1__Lcalculator_Expr__sci_List__sci_Map__D(a$3, dep, references) * this.$$undeval__p1__Lcalculator_Expr__sci_List__sci_Map__D(b$3, dep, references))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x6 = $as_Lcalculator_Divide(x1);
      var a$4 = x6.a$2;
      var b$4 = x6.b$2;
      return (this.$$undeval__p1__Lcalculator_Expr__sci_List__sci_Map__D(a$4, dep, references) / this.$$undeval__p1__Lcalculator_Expr__sci_List__sci_Map__D(b$4, dep, references))
    } else if ($is_Lcalculator_Literal(x1)) {
      var x7 = $as_Lcalculator_Literal(x1);
      var v = x7.v$2;
      return v
    } else {
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  if ($is_Lcalculator_Literal(expr)) {
    ...
    var name = x3.name$2;
    var jsx$1 = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references);
    $m_sci_List$();
    var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([name]);
    var this$2 = $m_sci_List$();
    var cbf = this$2.ReusableCBFInstance$2;
    return this.$$undeval__p1__Lcalculator_Expr__sci_List__sci_Map__D(jsx$1, $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf)), references)
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2) {
    return (function() {
      var delta$1 = $m_Lcalculator_Polynomial$().computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal(a$2, b$2, c$2);
      if (($uD(delta$1.apply__O()) > 0)) {
        var a$1 = $uD(delta$1.apply__O());
        var delta_root = $uD($g["Math"]["sqrt"](a$1));
        var array = [(((-$uD(b$2.apply__O())) + delta_root) / (2 * $uD(a$2.apply__O()))), (((-$uD(b$2.apply__O())) - delta_root) / (2 * $uD(a$2.apply__O())))];
        ...
        var delta_root$2 = $uD($g["Math"]["sqrt"](a$3));
        var array$1 = [(((-$uD(b$2.apply__O())) + delta_root$2) / (2 * $uD(a$2.apply__O())))];
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      var b_val = $uD(b$1.apply__O());
      return ((b_val * b_val) - ((4 * $uD(a$1.apply__O())) * $uD(c$1.apply__O())))
    })
  })(a, b, c));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, v$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(v$1.apply__O()), arg$outer.namedExpressions$1$f)
      })
    })(this, v));
